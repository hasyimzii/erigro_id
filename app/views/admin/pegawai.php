...
<div class="clearfix mb-20">
    <div class="pull-left">
        <h4 class="text-blue h4">Informasi Pegawai erigro.id</h4>
        <p class="mb-30">Data pegawai yang tersedia</p>
    </div>
    <div class="pull-right">
        <a class="btn btn-primary" href="<?= BASEURL; ?>/admin/createPegawai" role="button"><i class="icon-copy fa fa-plus" aria-hidden="true"></i> Tambah Bibit</a>
    </div>
</div>
